...
export default function Room() {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen px-20 py-10 bg-gray-200" id="room">
      {/* Title Section */}
      <motion.div
      ...
      {/* Room Cards Section */}
      <motion.div
        className="grid grid-cols-1 mb-10 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-10 "
        initial={{ opacity: 0 }}
