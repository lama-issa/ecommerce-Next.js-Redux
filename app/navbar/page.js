    ...
    <nav className="bg-gray-100 opacity-80 p-2  border-b-4 border-foreground" >
      <div className="max-w-screen-xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6 items-center">
          ...
          <a
            href="#about"
            className="text-black hover:bg-foreground px-3 py-2 inline-flex items-center hover:transition-all ease-out duration-300 hover:text-white"
          >
            About
          </a>
          <a
...
<a
      ...
      {isMenuOpen && (
        <div className="md:hidden ">
          ...
          <a href="#about" className="block text-black hover:bg-foreground px-4 py-2  items-center hover:transition-all ease-out duration-300 hover:text-white">
            About
          </a>
          <a href="#room" className="block text-black hover:bg-foreground px-4 py-2  items-center hover:transition-all ease-out duration-300 hover:text-white">
            Services
          </a>
          <a href="#Contact" className="block text-black hover:bg-foreground px-4 py-2  items-center hover:transition-all ease-out duration-300 hover:text-white">
            Contact
          </a>
